...
In the Balance config there are several config options to fine tune every skill, action, refinement, entities and player settings.  They are to many to display them here. An example can be viewed [here](./werewolves-balance.toml)
</TabItem>
</Tabs>

...
The effect is obtained by either being bitten by a werewolf (-player) or by interacting with a [Werewolf Tooth](./items.mdx#werewolf-tooth)
</Effect>

<Effect title="Howling" icon="howling.png">

The Howling effect is triggered by the Werewolf [Howl Action](../werewolf/skills.mdx#howling) and gives Attack Speed for Werewolves
</Effect>
...
This Unknown effect somehow cures you from the werewolf curse after being injected by a [Strange Injection](./items.mdx#strange-injection)
</Effect>

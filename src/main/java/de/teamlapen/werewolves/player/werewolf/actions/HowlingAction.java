...
public class HowlingAction extends DefaultWerewolfAction {
    ...
    protected boolean activate(IWerewolfPlayer werewolfPlayer) {
        ...
        entities.forEach(entity -> entity.addPotionEffect(new EffectInstance(WEffects.howling, (WerewolvesConfig.BALANCE.SKILLS.HOWLING.duration.get() + WerewolvesConfig.BALANCE.SKILLS.HOWLING.disabled_duration.get())*20)));
        return true;
    }

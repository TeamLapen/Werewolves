...
public class RecipeGenerator extends RecipeProvider {
    ...
    protected void registerRecipes(@Nonnull Consumer<IFinishedRecipe> consumer) {
        ...
        ShapelessRecipeBuilder.shapelessRecipe(ModBlocks.magic_planks, 4).addIngredient(ModBlocks.magic_log).addCriterion("has_magic_log", hasItem(ModBlocks.magic_log)).build(consumer, new ResourceLocation(REFERENCE.MODID, "magic_planks_from_magic_log"));
        ShapelessRecipeBuilder.shapelessRecipe(Blocks.OAK_PLANKS, 4).addIngredient(ModBlocks.jacaranda_log).addCriterion("has_jacaranda_log", hasItem(ModBlocks.jacaranda_log)).build(consumer, new ResourceLocation(REFERENCE.MODID, "oak_planks_from_jacaranda_log"));

        CookingRecipeBuilder.smeltingRecipe(Ingredient.fromTag(ModTags.Items.SILVER_ORE), ModItems.silver_ingot, 0.7F, 100).addCriterion("has_silver_ore", hasItem(ModTags.Items.SILVER_ORE)).build(consumer, new ResourceLocation(REFERENCE.MODID, "silver_ingot_from_blasting"));

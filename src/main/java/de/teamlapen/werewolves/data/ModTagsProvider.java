...
public class ModTagsProvider {
    ...
    private static class ModItemTagsProvider extends ItemTagsProvider {
        ...
        protected void addTags(HolderLookup.@NotNull Provider holderProvider) {
            ...
            this.tag(ModTags.Items.MEAT).addTags(ModTags.Items.RAWMEATS, ModTags.Items.COOKEDMEATS, ModTags.Items.RAW_FISH, ModTags.Items.COOKED_FISH);
            this.tag(ModTags.Items.RAW_FOOD).addTags(ModTags.Items.RAWMEATS, ModTags.Items.RAW_FISH);
        }

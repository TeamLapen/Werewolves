...
public class BlockStateGenerator extends BlockStateProvider {
    ...
    private void button(Block block, @NotNull ResourceLocation texture) {
        ...
        ModelFile button = models().withExistingParent("block/" + id.getPath(), new ResourceLocation("block/button")).texture("texture", texture);
        ModelFile button_pressed = models().withExistingParent("block/" + id.getPath() + "_pressed", new ResourceLocation("block/button_pressed")).texture("texture", texture);
        ModelFile button_inventory = models().withExistingParent("block/" + id.getPath() + "_inventory", new ResourceLocation("block/button_inventory")).texture("texture", texture);

...
public class SkillNodeGenerator extends de.teamlapen.vampirism.data.provider.SkillNodeProvider {
    ...
    protected void registerSkillNodes(@NotNull Consumer<FinishedSkillNode> consumer) {
        ...
        ResourceLocation skill2 = werewolf(skill1, ModSkills.NIGHT_VISION, ModSkills.SENSE).build(consumer, this.modId("skill2"));
        ...
        ResourceLocation survival1 = werewolf(skill2, ModSkills.JUMP, ModSkills.SPEED).build(consumer, this.modId("survival1"));
        ResourceLocation survival2 = werewolf(survival1, ModSkills.SURVIVAL_FORM).build(consumer, this.modId("survival2"));
        ResourceLocation survival3 = werewolf(survival2, ModSkills.WOLF_PAWN, ModSkills.CLIMBER).build(consumer, this.modId("survival3"));
        ResourceLocation survival4 = werewolf(survival3, ModSkills.EFFICIENT_DIET, ModSkills.ARROW_AWARENESS).build(consumer, this.modId("survival4"));
        ResourceLocation survival5 = werewolf(survival4, ModSkills.MOVEMENT_TACTICS).build(consumer, this.modId("survival5"));

        ResourceLocation survival31 = werewolf(survival3, ModSkills.LEAP).build(consumer, this.modId("survival31"));

...
public class LootTablesGenerator extends LootTableProvider {
    ...
    private static class ModBlockLootTables extends BlockLoot {
        ...
        protected void addTables() {
            ...
            this.add(ModBlocks.JACARANDA_DOOR.get(), BlockLoot::createDoorTable);
            this.add(ModBlocks.MAGIC_DOOR.get(), BlockLoot::createDoorTable);
            ...
            this.dropSelf(ModBlocks.WITCH_HEAD.get());
        }

...
public class ModBlocks extends de.teamlapen.vampirism.core.ModBlocks {
    ...
    static void registerBlocks(IForgeRegistry<Block> registry) {
        ...
        Block log1 = Blocks.createLogBlock(MaterialColor.BROWN, MaterialColor.BROWN).setRegistryName(REFERENCE.MODID, "jacaranda_log");
        ((FireBlock) Blocks.FIRE).setFireInfo(log1, 5, 5);
        ...
        Block log2 = Blocks.createLogBlock(MaterialColor.BLUE, MaterialColor.BLUE).setRegistryName(REFERENCE.MODID, "magic_log");
        ((FireBlock) Blocks.FIRE).setFireInfo(log2, 5, 5);

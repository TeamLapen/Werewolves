...
public class ModBlocks {
    ...
    public static final RegistryObject<LogBlock> STRIPPED_JACARANDA_LOG = registerWithItem("stripped_jacaranda_log", () -> new LogBlock(MaterialColor.COLOR_BLACK, MaterialColor.COLOR_PINK));
    public static final RegistryObject<LogBlock> STRIPPED_MAGIC_LOG = registerWithItem("stripped_magic_log", () -> new LogBlock(MaterialColor.COLOR_LIGHT_BLUE, MaterialColor.COLOR_LIGHT_BLUE));
    public static final RegistryObject<LogBlock> JACARANDA_LOG = registerWithItem("jacaranda_log", () -> new StrippableLogBlock(MaterialColor.COLOR_PINK, MaterialColor.COLOR_PINK, STRIPPED_JACARANDA_LOG));
    public static final RegistryObject<LogBlock> MAGIC_LOG = registerWithItem("magic_log", () -> new StrippableLogBlock(MaterialColor.COLOR_LIGHT_BLUE, MaterialColor.COLOR_LIGHT_BLUE, STRIPPED_MAGIC_LOG));
    ...
    public static final RegistryObject<DoorBlock> JACARANDA_DOOR = registerWithItem("jacaranda_door", () -> new DoorBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.COLOR_PINK).strength(3.0F).sound(SoundType.WOOD).noOcclusion()));
    public static final RegistryObject<DoorBlock> MAGIC_DOOR = registerWithItem("magic_door", () -> new DoorBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.COLOR_LIGHT_BLUE).strength(3.0F).sound(SoundType.WOOD).noOcclusion()));
    public static final RegistryObject<TrapDoorBlock> JACARANDA_TRAPDOOR = registerWithItem("jacaranda_trapdoor", () -> new TrapDoorBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.COLOR_PINK).strength(3.0F).sound(SoundType.WOOD).noOcclusion().isValidSpawn((p_61031_, p_61032_, p_61033_, p_61034_) -> false)));
    public static final RegistryObject<TrapDoorBlock> MAGIC_TRAPDOOR = registerWithItem("magic_trapdoor", () -> new TrapDoorBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.COLOR_LIGHT_BLUE).strength(3.0F).sound(SoundType.WOOD).noOcclusion().isValidSpawn((p_61031_, p_61032_, p_61033_, p_61034_) -> false)));
    ...
    public static final RegistryObject<LogBlock> JACARANDA_WOOD = registerWithItem("jacaranda_wood", () -> new StrippableLogBlock(MaterialColor.COLOR_PINK, MaterialColor.COLOR_PINK, STRIPPED_JACARANDA_WOOD));
    public static final RegistryObject<LogBlock> MAGIC_WOOD = registerWithItem("magic_wood", () -> new StrippableLogBlock(MaterialColor.COLOR_LIGHT_BLUE, MaterialColor.COLOR_LIGHT_BLUE, STRIPPED_MAGIC_WOOD));
    ...
    public static final RegistryObject<PressurePlateBlock> JACARANDA_PRESSURE_PLATE = registerWithItem("jacaranda_pressure_plate", () -> new PressurePlateBlock(PressurePlateBlock.Sensitivity.EVERYTHING, BlockBehaviour.Properties.of(Material.WOOD, JACARANDA_PLANKS.get().defaultMaterialColor()).noCollission().strength(0.5F).sound(SoundType.WOOD)));
    public static final RegistryObject<PressurePlateBlock> MAGIC_PRESSURE_PLATE = registerWithItem("magic_pressure_plate", () -> new PressurePlateBlock(PressurePlateBlock.Sensitivity.EVERYTHING, BlockBehaviour.Properties.of(Material.WOOD, MAGIC_PLANKS.get().defaultMaterialColor()).noCollission().strength(0.5F).sound(SoundType.WOOD)));
    public static final RegistryObject<WoodButtonBlock> JACARANDA_BUTTON = registerWithItem("jacaranda_button", () -> new WoodButtonBlock(BlockBehaviour.Properties.of(Material.DECORATION).noCollission().strength(0.5F).sound(SoundType.WOOD)));
    public static final RegistryObject<WoodButtonBlock> MAGIC_BUTTON = registerWithItem("magic_button", () -> new WoodButtonBlock(BlockBehaviour.Properties.of(Material.DECORATION).noCollission().strength(0.5F).sound(SoundType.WOOD)));
    ...
    public static final RegistryObject<FenceGateBlock> JACARANDA_FENCE_GATE = registerWithItem("jacaranda_fence_gate", () -> new FenceGateBlock(BlockBehaviour.Properties.of(Material.WOOD, JACARANDA_PLANKS.get().defaultMaterialColor()).strength(2.0F, 3.0F).sound(SoundType.WOOD)));

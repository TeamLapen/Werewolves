...
public class ModItems {
    ...
    public static final RegistryObject<Item> WOLF_BERRIES = register("wolf_berries", () -> new WolfBerries(ModBlocks.WOLF_BERRY_BUSH.get(), props().food(new FoodProperties.Builder().nutrition(2).saturationMod(0.1f).build())));

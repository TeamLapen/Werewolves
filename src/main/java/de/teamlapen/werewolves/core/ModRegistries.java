...
public class ModRegistries extends de.teamlapen.vampirism.core.ModRegistries {
    ...
    public static final IForgeRegistry<WeaponOil> WEAPON_OILS;

    static {
        WEAPON_OILS = new RegistryBuilder<WeaponOil>().setName(WEAPON_OIL_ID).setType(WeaponOil.class).setMaxID(Integer.MAX_VALUE >> 5).create();
    }

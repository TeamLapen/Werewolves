...
public class WerewolfVillageData implements IVillageFactionData {
    ...
    private final List<CaptureEntityEntry> captureEntityEntries = Lists.newArrayList(new CaptureEntityEntry(ModEntities.transformed_werewolf, 10));

    @Override
    public Class<? extends MobEntity> getGuardSuperClass() {
        return TransformedWerewolfEntity.class;
    }

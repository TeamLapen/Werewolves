...
public class WerewolvesBiomeFeatures {
    ...
    public static final Holder<ConfiguredFeature<OreConfiguration, Feature<OreConfiguration>>> silver_ore = registerConfiguredFeature("silver_ore", Feature.ORE, new OreConfiguration(ORE_SILVER_TARGET_LIST, 5));

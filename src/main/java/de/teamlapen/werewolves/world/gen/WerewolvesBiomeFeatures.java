...
public class WerewolvesBiomeFeatures {
    ...
    public static final Holder<ConfiguredFeature<OreConfiguration, Feature<OreConfiguration>>> silver_ore = registerConfiguredFeature("silver_ore", Feature.ORE, new OreConfiguration(OreFeatures.NATURAL_STONE, ModBlocks.silver_ore.defaultBlockState(), 5));
    ...
    public static final Holder<PlacedFeature> silver_ore_placed = PlacementUtils.register(REFERENCE.MODID + ":silver_ore", silver_ore, commonOrePlacement(16, HeightRangePlacement.triangle(VerticalAnchor.absolute(-16), VerticalAnchor.absolute(112))));

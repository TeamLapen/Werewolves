...
public class BeastWerewolfFormAction extends WerewolfFormAction {
    ...
    public BeastWerewolfFormAction() {
        ...
        attributes.add(new Modifier(Attributes.ATTACK_DAMAGE, UUID.fromString("2792aac3-5ae1-47d9-8ba6-0b473b6b666a"), UUID.fromString("07a8e8e1-ff43-41f9-8053-c947482ef6c2"), 0.5, "beast_form_attack_damage", () -> WerewolvesConfig.BALANCE.SKILLS.beast_form_attack_damage.get() * 0.5, WerewolvesConfig.BALANCE.SKILLS.beast_form_attack_damage::get, WerewolfSkills.damage, AttributeModifier.Operation.MULTIPLY_TOTAL));
    }
    ...
    protected int getWerewolfTimeLimit(IWerewolfPlayer werewolf) {
        ...
        if (werewolf.getSkillHandler().isRefinementEquipped(ModRefinements.werewolf_form_duration_beast)) {
            limit += WerewolvesConfig.BALANCE.REFINEMENTS.werewolf_form_duration_beast.get() * 20;
        }
        return limit;
    }
}

...
public class TransformedWerewolfEntity extends VampirismEntity implements IVillageCaptureEntity, IEntityActionUser, IWerewolfMob {
    ...
    public TransformedWerewolfEntity(EntityType<? extends TransformedWerewolfEntity> type, World world) {
        super(type, world);
    ...
    public static TransformedWerewolfEntity createFromVillager(AbstractVillagerEntity villager) {
        TransformedWerewolfEntity werewolf = ModEntities.transformed_werewolf.create(villager.world);
    ...
    public static boolean spawnPredicateWerewolf(EntityType<? extends TransformedWerewolfEntity> entityType, IWorld world, SpawnReason spawnReason, BlockPos blockPos, Random random) {
